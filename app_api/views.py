...
class MovieViewSet(viewsets.ModelViewSet):
	...
	# permission_classes = (rest_framework.permissions.AllowAny,) # Allow only on GET
	permission_classes = (rest_framework.permissions.IsAuthenticated,)  # Require on POST
	...
	def rate_movie(self, request, pk=None):
		...
		rating, isCreated = models.Rating.objects.update_or_create(user=user, movie=movie,
		...
		response = {
			'action': 'rating',
			'status': 'created' if isCreated else 'updated',
			'movieRating': ratingSerialized.data,
		}
